...
- [View on GitHub](https://github.com/aaron777collins/open-design)
- [Project Homepage](https://open-design.ai)

## 📊 Project Details

- **Primary Language:** None
- **Languages Used:** TypeScript, HTML, CSS, JavaScript, Astro, Python, Shell, Nix, PowerShell, Bicep
